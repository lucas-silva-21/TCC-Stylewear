        ...
        <>
            <div className="fundo_dest">
                    <ul>
                        ...
                        <li><a href="/Categoria+Calças"><Bolha text="Calças" img="./Categoria/Calça_categ.png" alt="Imagem de Calça"/></a></li>
                        <li><a href="/Categoria+Shorts"><Bolha text="Shorts" img="./Categoria/Blusa_categ.png" alt="Imagem de Short"/></a></li>
                        <li><a href="/Categoria+Camisetas"><Bolha text="Camisetas" img="./Categoria/Camiseta_categ.png" alt="Imagem de Camiseta"/></a></li>
