...
function Carousel(props) {
  ...
  const DATA_UMBRO = {
    'Tênis': makeItems(['/Pg_Surfgang/Tenis1.png', '/Pg_Surfgang/Tenis2.png'], 24, 'Tênis Umbro'),
    'Shorts': makeItems(['/Pg_Surfgang/Short1.png', '/Pg_Surfgang/Short2.png' , '/Pg_Surfgang/Short3.png'], 24, 'Short Umbro'),
    'Calças': makeItems(['/Pg_Surfgang/Calça1.png', '/Pg_Surfgang/Calça2.png'], 24, 'Calça Umbro'),
    'Camisetas': makeItems(['/Pg_Surfgang/Camiseta1.png'], 24, 'Camiseta Umbro'),
    'Blusas': makeItems(['/Pg_Surfgang/Blusa1.png'], 24, 'Blusa Umbro'),
    'Bonés': makeItems(['/Pg_Surfgang/Bone1.png'], 24, 'Boné Umbro'),
    'Acessórios': makeItems(['/Pg_Surfgang/Acessorio1.png', '/Pg_Surfgang/Acessorio2.png'], 24, 'Acessório Umbro'),
  };
