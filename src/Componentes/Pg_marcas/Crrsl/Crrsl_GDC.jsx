...
function Carousel(props) {
  ...
  const DATA_UMBRO = {
    'Tênis': makeItems(['/Pg_GNC/Tenis1.png', '/Pg_GNC/Tenis2.png'], 24, 'Tênis Umbro'),
    'Shorts': makeItems(['/Pg_GNC/Short1.png', '/Pg_GNC/Short2.png'], 24, 'Short Umbro'),
    'Calças': makeItems(['/Pg_GNC/Calça1.png'], 24, 'Calça Umbro'),
    'Camisetas': makeItems(['/Pg_GNC/Camiseta1.png'], 24, 'Camiseta Umbro'),
    'Blusas': makeItems(['/Pg_GNC/Blusa1.png'], 24, 'Blusa Umbro'),
    'Bonés': makeItems(['/Pg_GNC/Bone1.png'], 24, 'Boné Umbro'),
    'Acessórios': makeItems(['/Pg_GNC/Acessorio1.png'], 24, 'Acessório Umbro'),
  };
