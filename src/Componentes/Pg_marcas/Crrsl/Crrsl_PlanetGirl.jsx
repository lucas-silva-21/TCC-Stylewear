...
function Carousel(props) {
  ...
  const DATA_UMBRO = {
    'Tênis': makeItems(['/Pg_PlanetGirl/Tenis1.png', '/Pg_PlanetGirl/Tenis2.png'], 24, 'Tênis Umbro'),
    'Shorts': makeItems(['/Pg_PlanetGirl/Short1.png', '/Pg_PlanetGirl/Short2.png' , '/Pg_PlanetGirl/Short3.png'], 24, 'Short Umbro'),
    'Calças': makeItems(['/Pg_PlanetGirl/Calça1.png', '/Pg_PlanetGirl/Calça2.png'], 24, 'Calça Umbro'),
    'Camisetas': makeItems(['/Pg_PlanetGirl/Camiseta1.png'], 24, 'Camiseta Umbro'),
    'Blusas': makeItems(['/Pg_PlanetGirl/Blusa1.png'], 24, 'Blusa Umbro'),
    'Bonés': makeItems(['/Pg_PlanetGirl/Bone1.png'], 24, 'Boné Umbro'),
    'Acessórios': makeItems(['/Pg_PlanetGirl/Acessorio1.png', '/Pg_PlanetGirl/Acessorio2.png'], 24, 'Acessório Umbro'),
  };
              ...
              <div className='div-card' key={index}>
                <div className="form-check hanger">
                  <input
                    ...
                    checked={!!selBlusa[index]}
                    onChange={() => toggle(setSelBlusa, index)}
                  />
              ...
              <div className='div-card' key={index}>
                <div className="form-check hanger">
                  <input
                    ...
                    checked={!!selBone[index]}
                    onChange={() => toggle(setSelBone, index)}
                  />
