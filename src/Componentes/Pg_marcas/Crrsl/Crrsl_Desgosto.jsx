...
function Carousel(props) {
  ...
  const DATA_UMBRO = {
    'Tênis': makeItems(['/Pg_Desgosto/Tenis1.png', '/Pg_Desgosto/Tenis2.png'], 24, 'Tênis Umbro'),
    'Shorts': makeItems(['/Pg_Desgosto/Short1.png', '/Pg_Desgosto/Short2.png'], 24, 'Short Umbro'),
    'Calças': makeItems(['/Pg_Desgosto/Calça1.png'], 24, 'Calça Umbro'),
    'Camisetas': makeItems(['/Pg_Desgosto/Camiseta1.png'], 24, 'Camiseta Umbro'),
    'Blusas': makeItems(['/Pg_Desgosto/Blusa1.png'], 24, 'Blusa Umbro'),
    'Bonés': makeItems(['/Pg_Desgosto/Bone1.png'], 24, 'Boné Umbro'),
    'Acessórios': makeItems(['/Pg_Desgosto/Acessorio1.png'], 24, 'Acessório Umbro'),
  };
