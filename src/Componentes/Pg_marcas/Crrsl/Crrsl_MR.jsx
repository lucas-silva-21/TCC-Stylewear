...
function Carousel(props) {
  ...
  const DATA_UMBRO = {
    'Tênis': makeItems(['/Pg_MR/Tenis1.png', '/Pg_MR/Tenis2.png'], 24, 'Tênis Umbro'),
    'Shorts': makeItems(['/Pg_MR/Short1.png', '/Pg_MR/Short2.png' , '/Pg_MR/Short3.png'], 24, 'Short Umbro'),
    'Calças': makeItems(['/Pg_MR/Calça1.png', '/Pg_MR/Calça2.png'], 24, 'Calça Umbro'),
    'Camisetas': makeItems(['/Pg_MR/Camiseta1.png'], 24, 'Camiseta Umbro'),
    'Blusas': makeItems(['/Pg_MR/Blusa1.png'], 24, 'Blusa Umbro'),
    'Bonés': makeItems(['/Pg_MR/Bone1.png'], 24, 'Boné Umbro'),
    'Acessórios': makeItems(['/Pg_MR/Acessorio1.png', '/Pg_MR/Acessorio2.png'], 24, 'Acessório Umbro'),
  };
