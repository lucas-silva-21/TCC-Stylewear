...
function Carousel(props) {
  ...
  const DATA_UMBRO = {
    'Tênis': makeItems(['/Pg_Polo/Tenis1.png', '/Pg_Polo/Tenis2.png'], 24, 'Tênis Umbro'),
    'Shorts': makeItems(['/Pg_Polo/Short1.png', '/Pg_Polo/Short2.png' , '/Pg_Polo/Short3.png'], 24, 'Short Umbro'),
    'Calças': makeItems(['/Pg_Polo/Calça1.png', '/Pg_Polo/Calça2.png'], 24, 'Calça Umbro'),
    'Camisetas': makeItems(['/Pg_Polo/Camiseta1.png'], 24, 'Camiseta Umbro'),
    'Blusas': makeItems(['/Pg_Polo/Blusa1.png'], 24, 'Blusa Umbro'),
    'Bonés': makeItems(['/Pg_Polo/Bone1.png'], 24, 'Boné Umbro'),
    'Acessórios': makeItems(['/Pg_Polo/Acessorio1.png', '/Pg_Polo/Acessorio2.png'], 24, 'Acessório Umbro'),
  };
