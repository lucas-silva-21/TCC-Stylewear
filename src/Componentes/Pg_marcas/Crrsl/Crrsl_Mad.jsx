...
function Carousel(props) {
  ...
  const DATA_UMBRO = {
    'Tênis': makeItems(['/Pg_Mad/Tenis1.png', '/Pg_Mad/Tenis2.png'], 24, 'Tênis Umbro'),
    'Shorts': makeItems(['/Pg_Mad/Short1.png', '/Pg_Mad/Short2.png' , '/Pg_Mad/Short3.png'], 24, 'Short Umbro'),
    'Calças': makeItems(['/Pg_Mad/Calça1.png', '/Pg_Mad/Calça2.png'], 24, 'Calça Umbro'),
    'Camisetas': makeItems(['/Pg_Mad/Camiseta1.png'], 24, 'Camiseta Umbro'),
    'Blusas': makeItems(['/Pg_Mad/Blusa1.png'], 24, 'Blusa Umbro'),
    'Bonés': makeItems(['/Pg_Mad/Bone1.png'], 24, 'Boné Umbro'),
    'Acessórios': makeItems(['/Pg_Mad/Acessorio1.png', '/Pg_Mad/Acessorio2.png'], 24, 'Acessório Umbro'),
  };
